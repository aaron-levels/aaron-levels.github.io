...
const FEATURED: FeaturedProject[] = [
  ...
  },
  {
    ...
    description:
      "Building a 3-tier VPC architecture — public/private subnets, NAT gateway, security groups, and NACLs — hosting a static site via S3 and Route 53, with least-privilege IAM policies and CloudWatch monitoring.",
    tags: ["AWS", "VPC", "S3", "Route 53", "IAM", "CloudWatch"],
    links: [
      { label: "View Code", href: "https://github.com/aaron-levels", variant: "code" },
      // TODO: swap for the real URL once the S3/CloudFront deployment is fully live
      { label: "Live Demo (In Progress)", href: "https://resume.aaronmathias.me", variant: "demo" },
    ],
    icon: Cloud,
    status: "progress",
  },
...
const EXPERIENCE: Job[] = [
  {
    ...
    bullets: [
      "Serve as primary remote resolver using structured troubleshooting across 3,500+ endpoints; isolate root causes for software, L1–L3 networking, and hardware faults to maintain 98%+ SLA adherence.",
      "Manage QA, provisioning, MAC validation, and component diagnostics (motherboards, RAM, PSUs) across the hardware lifecycle.",
      "Act as technical liaison for field engineers (NCR, Burroughs, Chubb, Securitas), managing a high volume of tickets and coordinating incident response via ServiceNow ITSM.",
      "Streamlined repair flows and renegotiated vendor SLAs, delivering $1M+ in annualized savings.",
      "Developed team Excel VBA macros to process daily metric data, accelerating reporting speed and identifying break-fix trends.",
      "Onboarded 400+ sites with zero rollout cutover downtime and authored SOP documentation for SD-WAN deployments.",
      "Provide on-call incident response with flexibility to work various shifts, including periodic coverage outside core hours.",
      "Participate in change management activities, including pre-change planning and post-change testing to validate network and hardware stability.",
    ],
  },
  {
    id: "bmo-rep",
...
const SKILL_GROUPS: SkillGroup[] = [
  ...
  },
  {
    ...
    icon: Wrench,
    items: [
      "Layer 1/2 copper/fiber patching",
      "Asset management",
      "FIS PaySys",
      "Git/GitHub",
      "VS Code",
...
const CERTS: Cert[] = [
  ...
  { name: "AWS Cloud Practitioner", status: "earned", detail: "Earned Aug 2026" },
  { name: "Microsoft AZ-104", status: "progress", detail: "In Progress" },
];
          ...
          <div className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <p>
                ...
                a B.S. in Cloud and Network Engineering (AWS) at WGU, expected
                Dec 2028; CompTIA A+, CompTIA Network+, and AWS Cloud
                Practitioner certified, with Microsoft AZ-104 in progress.
              </p>
